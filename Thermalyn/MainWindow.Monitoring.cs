...
public partial class MainWindow
{
    ...
    private ThermalComponent ComponentKind(ComponentReading reading) => ReferenceEquals(reading, _snapshot.Cpu)
        ...
        : ReferenceEquals(reading, _snapshot.Memory) || reading.Kind == "RAM"
            ? ThermalComponent.Memory : ThermalComponent.Storage;
    ...
    private void CheckThermalNotifications()
    {
        ...
        Check(_snapshot.Gpu, "GPU:" + _snapshot.Gpu.Name,
            LocalizationService.Get(_snapshot.Gpu.IsIntegratedGpu ? "Common.IntegratedGraphics" : "Head.GraphicsCard"));
