...
// Notification area through Shell_NotifyIcon.
internal sealed class TrayService : IDisposable
{
    ...
    // Notifications sent back through CallbackMessage.
    ...
    // Menu and icon flags, from winuser.h.
    ...
    {
        if (!_visible) return;
        // Drop the balloon rather than queue it: a stale temperature warning is useless.
