...
/// <summary>
/// Swaps the merged string dictionary at runtime. Get runs on worker threads, and a
/// ResourceDictionary is not safe to read concurrently, so the strings are snapshotted.
/// </summary>
public static class LocalizationService
{
    ...
    // Missing key falls back to the key itself, which is visible but harmless.
