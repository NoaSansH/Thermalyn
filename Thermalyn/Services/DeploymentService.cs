...
/// <summary>Distinguishes the installed build from the portable one.</summary>
    ...
    public static bool IsInstalled()
    {
        ...
        foreach (var view in new[] { RegistryView.Registry64, RegistryView.Registry32 })
        {
            try
            {
                ...
                // The registry may or may not keep a trailing separator; compare the folders themselves.
