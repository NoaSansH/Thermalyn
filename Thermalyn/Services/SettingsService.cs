...
public sealed class SettingsService
{
    ...
    public void Save(AppSettings settings)
    {
        ...
        // Written aside and moved into place: a half-written file reads back as no settings at all.
        var staged = FilePath + ".tmp";
        File.WriteAllText(staged, JsonSerializer.Serialize(settings, WriteOptions));
