...
public enum ThermalComponent { Cpu, Gpu, Storage }
...
// One notification per episode, plus a global cooldown. Needs uninterrupted readings.
public sealed class ThermalAlertService
{
        ...
        int delaySeconds, int cooldownMinutes, int refreshSeconds)
    {
        ...
        // A two-degree recovery margin avoids repeated episodes around the configured threshold.
