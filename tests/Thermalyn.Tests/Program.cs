...
if (args.Contains("--repository-contracts", StringComparer.OrdinalIgnoreCase))
{
    ...
    // The vocabulary above only knows words the translators happened to use, which let two window
    // tooltips through. Nothing readable may be assigned to Text, Content or ToolTip in code.
